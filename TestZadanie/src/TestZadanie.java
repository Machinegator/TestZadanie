...
class Main {
    ...
    public static String calc(String input) {
        ...
        String virazhenie = input;
        sch(virazhenie);
        return virazhenie;
    }

    static void sch(String virazhenie) {
        ...
        res(perv1, vtor1, actZnak, arab, rim, znaki, preobrazovanie);

    }

    static void res(String perv1, String vtor1, int actZnak, String[] arab, String[] rim, String[] znaki, String[] preobrazovanie) {
